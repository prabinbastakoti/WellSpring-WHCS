...
function App() {
  ...
  return (
    ...
    <div className="h-screen flex bg-[#FAFAFA] relative">
      <p className='absolute bottom-8 left-20 text-xs text-gray-400 font-serif lowercase'><a href="https://www.freepik.com/free-vector/medics-working-charts_4950249.htm#query=hospital%20management&position=0&from_view=keyword&track=ais&uuid=1eb5c821-c821-4428-8f49-83c3147d77d0">* Image by katemangostar</a> on Freepik</p>
        <img src={background} className='w-3/5 object-cover '/>

      <div className="flex-1 my-auto pr-20">
          <img src={logo} className='mb-8 w-60 h-60 mx-auto'/>
...
<div class="relative w-3/5">
    ...
    <label for="password" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Password</label>
          ...
          <button className='bg-blue-500 my-3 py-2 px-8 rounded-md outline-none border-none text-white text-base text-center hover:brightness-105'>Login</button>
          </form>
